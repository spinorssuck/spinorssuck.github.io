...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/quantum_counting/oracle_first.png" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/quantum_counting/algorithm_second.png" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/quantum_counting/r_third.png" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
